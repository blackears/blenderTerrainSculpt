...
class TerrainSculptMeshProperties(bpy.types.PropertyGroup):
    ...
    radius_relative_to_view : bpy.props.BoolProperty(
        name = "Radius relative to View", 
        description = "If true, adjust the brush radius to be proportionate to the viewport.", 
        default = False
    )

    radius_relative_to_view_scale : bpy.props.FloatProperty(
        name = "Radius Relative To View Scale", 
        description = "Fixed adjustment to brush radius when in proportional mode.", 
        default = .1, 
        min = 0, 
        soft_max = 1
    )
    ...
    use_slope_angle : bpy.props.BoolProperty(
        name = "Use Slope Angle", 
        description = "If true, uses the specified slope angle.  Otherwise, slope will be calculated form current terrain slope.", 
        default = False
    )

    slope_angle : bpy.props.FloatProperty(
        name = "Slope Angle", 
        description = "Slope angle to use when drawing slopes.", 
        default = 45, 
        soft_min = 0,
        soft_max = 90
    )
